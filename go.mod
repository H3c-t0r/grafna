...
require (
	...
	github.com/centrifugal/centrifuge v0.33.0 // @grafana/grafana-app-platform-squad
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240729130650-eee66882ef67 // @grafana/grafana-app-platform-squad
