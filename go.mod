...
require (
	...
	github.com/centrifugal/centrifuge v0.33.1 // @grafana/grafana-app-platform-squad
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240805130148-338b318bf4df // @grafana/grafana-app-platform-squad
