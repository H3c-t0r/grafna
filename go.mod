...
require (
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240812131506-d00b4879d24d // @grafana/grafana-app-platform-squad
...
require (
	...
	github.com/grafana/authlib/claims v0.0.0-20240809101159-74eaccc31a06 // indirect
