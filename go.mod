...
require (
	...
	github.com/grafana/grafana/pkg/apiserver v0.0.0-20240819134245-43dba8c3f9f5 // @grafana/grafana-app-platform-squad
...
require (
	...
	github.com/grafana/authlib/claims v0.0.0-20240814072707-6cffd53bb828 // indirect
